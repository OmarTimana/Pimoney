...
public class ActualizarCli extends javax.swing.JFrame {
    ...
    public ActualizarCli(String usu){
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActualizarCli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(ActualizarCli.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
